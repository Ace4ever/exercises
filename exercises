...
var indesOfOrphans = sonnetText.indexOf("orphans");
console.log("indexOfOrphans", indesOfOrphans);
console.log("length of sonnet", sonnetText.length);

sonnetElement.innerHTML = sonnetText.replace("winter", "yuletide").replace(/the/g, "a large");